...
class Test(unittest.TestCase):
    ...
    def test_edit_comment_working(self):
        ...
        message = task.edit_comment(0, "finish my homework, pay the bills")
        expected = "finish my homework, pay the bills"
        self.assertEqual(message, expected)

    def test_edit_comment_not_found(self):
        task = Task("Tst", "27.04.2020")
        task.add_comment("pay the bills")
        message = task.edit_comment(1, "finish my homework, pay the bills")
